...
@Component({
  selector: 'app-periodic-sales-report-by-store',
  templateUrl: './periodic-sales-report-by-store.component.html',
  styleUrls: ['./periodic-sales-report-by-store.component.css']
})

export class PeriodicSalesReportByStoreComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dataFromService.getServerData("PeriodicReportbyStore", "titlewindow1_creationCompleteHandler", [""])
    ...
    thisComponent.datasource = new CustomStore({
      load: function (loadOptions) {
        ...
        if (thisComponent.formdataforbutton["fromDate"]) {
          ...
          thisComponent.dataFromService.getServerData("PeriodicReportbyStore", "getList", ["",
            currUserStamp,
            ...
            UtilsForGlobalData.getUserId()]).subscribe(dataLines => {
              ...
              thisComponent.dataFromService.getServerData("PeriodicReportbyStore", "onGetGeneralStats", ["",
    ...
    thisComponent.itemdata = new CustomStore({
      load: function (loadOptions) {
        var devru = $.Deferred();
        if (thisComponent.formdataforbutton["fromDate"]) {
          thisComponent.dataFromService.getServerData("PeriodicReportbyStore", "getGroup1Data", ["",
            thisComponent.formdataforbutton["StoreID"],
            thisComponent.formdataforbutton["fromDate"],
    ...
    thisComponent.variantdata = new CustomStore({
      load: function (loadOptions) {
        var devru = $.Deferred();
        thisComponent.dataFromService.getServerData("PeriodicReportbyStore", "getGroup2Data", ["",
          thisComponent.formdataforbutton["StoreID"],
          thisComponent.formdataforbutton["fromDate"],
          thisComponent.formdataforbutton["toDate"]]).subscribe(dataLines => {
            devru.resolve(dataLines);
    ...
    thisComponent.categorydata = new CustomStore({
      load: function (loadOptions) {
        var devru = $.Deferred();
        thisComponent.dataFromService.getServerData("PeriodicReportbyStore", "getGroup3Data", ["",
          thisComponent.formdataforbutton["StoreID"],
          thisComponent.formdataforbutton["fromDate"],
          thisComponent.formdataforbutton["toDate"]]).subscribe(dataLines => {
            devru.resolve(dataLines);
    ...
    thisComponent.branddata = new CustomStore({
      load: function (loadOptions) {
        var devru = $.Deferred();
        thisComponent.dataFromService.getServerData("PeriodicReportbyStore", "getGroup4Data", ["",
          thisComponent.formdataforbutton["StoreID"],
          thisComponent.formdataforbutton["fromDate"],
          thisComponent.formdataforbutton["toDate"]]).subscribe(dataLines => {
            devru.resolve(dataLines);
    ...
    thisComponent.paymentdata = new CustomStore({
      load: function (loadOptions) {
        var devru = $.Deferred();
        thisComponent.dataFromService.getServerData("PeriodicReportbyStore", "getGroup5Data", ["",
          thisComponent.formdataforbutton["StoreID"],
          thisComponent.formdataforbutton["fromDate"],
          thisComponent.formdataforbutton["toDate"]]).subscribe(dataLines => {
            devru.resolve(dataLines);
  ...
  formSummary_fieldDataChanged(e) {
    if (e.dataField == 'StoreID' || e.dataField == 'fromDate' || e.dataField == 'toDate') {
      try {
  ...
  OnCreateReport() {
    if (this.formdataforbutton["fromDate"] ? this.formdataforbutton["toDate"] ?
      this.formdataforbutton["StoreID"] : false : false) {

...
export class TransferIntransitDetailsHttpDataService {
  ...
  handleMasterLookupITC(parameter): any {
    return this.dataFromService.getServerData("wmsTrasnferAdv", "handleMasterLookupITC", parameter)
      .map(dataStatus => {
        return dataStatus;
      });
  }
  ...
  btnSend_clickHandler2(parameter): any {
    return this.dataFromService.getServerData("wmsTrasnferAdv", "btnSend_clickHandler2", parameter)
      .map(dataStatus => {
        return dataStatus;
      });
  }
